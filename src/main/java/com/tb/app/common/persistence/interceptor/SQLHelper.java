...
import com.tb.app.common.persistence.dialect.Dialect;
import com.tb.app.common.utils.Reflections;
...
public class SQLHelper {
    ...
    public static int getCount(final String sql, final Connection connection,
    	...
    	final String countSql =FormatSql.replaceSelectColumn2Count(sql);

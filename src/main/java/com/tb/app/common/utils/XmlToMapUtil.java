...
public class XmlToMapUtil {
    ...
    public static String formatXml(String xmlStr) throws Exception {
        ...
        return formatXmlStream(document);
    }
     ...
     * @throws IOException
     */
    public static String formatXmlStream(Document document) throws Exception {
        // 格式化输出格式
     ...
     * @return void
     * @author Benjamin
     * @description [**将文档输出到本地文件**]
     * @date 14:39 2019/12/12
     * @version 1.0
     **/
    public static void documentToFile(Document document, File outFile) throws Exception {
        // 格式化输出格式
        OutputFormat format = OutputFormat.createPrettyPrint();
        //format.setEncoding("UTF-8");

...
public class User extends DataEntity<User> {
	...
	private String loginFlagLabel;//描述性信息，系统表相关就不改原属性了
	...
	private String activeUserId;//当前选择账号

	private List<Role> roleList = Lists.newArrayList(); // 拥有角色列表
	
	public User() {
		super();
		this.loginFlag = Constant.USER_LOGINFLAG_NORMAL;
	}
	...
	public void setLoginFlagLabel(String loginFlagLabel) {

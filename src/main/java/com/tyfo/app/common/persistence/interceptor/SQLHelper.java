 ...
 * 
 */
package com.tyfo.app.common.persistence.interceptor;


import com.tyfo.app.common.persistence.Page;
import com.tyfo.app.common.persistence.dialect.Dialect;
import com.tyfo.app.common.utils.Reflections;
...
//        final String countSql = "select count(1) " + removeSelect(removeOrders(sql));
        ...
        try {
        	if (log.isDebugEnabled()) {
                log.debug("COUNT SQL: " + StringUtils.replaceEach(countSql, new String[]{",","\t"}, new String[]{" "," "}));
            }
        	if (conn == null){

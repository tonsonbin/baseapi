...
public class JwtUtil {
     ...
     * JWT 生成密钥使用的密码
     */
    private static final String JWT_RULE = "WWW.TYFO.COM&#@XCGB";
    ...
    public static Boolean checkJWT(Key key, String claimsJws, String sub) {
        ...
        try {
            ...
            throw new RuntimeException("JWT验证出错，错误原因：{}"+e.getMessage());
        }
        return flag;
    }
     ...
     * @return
     */
    public static Claims getJWTPlayLoad(String claimsJws) {
    ...
    public static void main(String[] args) {
        ...
        String res=buildJWT("1_1",6000);

        System.out.println(res);

        Claims claims=getJWTPlayLoad(res);

...
<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctxStatic }/mui-pages/login/css/feedback-page.css" />
	</head>
	...
	<script src="${ctxStatic }/mui-pages/login/js/mui.view.js "></script>
	<script src='${ctxStatic }/mui-pages/login/libs/easymob-webim-sdk/jquery-1.11.1.js'></script>
	<script src='${ctxStatic }/mui-pages/login/libs/easymob-webim-sdk/strophe-custom-2.0.0.js'></script>
	<script src='${ctxStatic }/mui-pages/login/libs/easymob-webim-sdk/json2.js'></script>
	<script src="${ctxStatic }/mui-pages/login/libs/easymob-webim-sdk/easemob.im-1.0.5.js"></script>
	<script src='${ctxStatic }/mui-pages/login/js/feedback.js'></script>
	<script src="${ctxStatic }/mui-pages/login/js/feedback-page.js"></script>
	<script src="${ctxStatic }/mui-pages/login/js/mui.locker.js"></script>
	<script>
		mui.init();
		 //初始化单页view
